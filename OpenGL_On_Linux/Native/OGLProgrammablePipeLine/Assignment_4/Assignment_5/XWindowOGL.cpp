...
GLuint gvao_triangle_color;

GLuint gVao_square_position;
GLuint gvao_square_color;
...
gpDisplay=XOpenDisplay(NULL);
	...
	XStoreName(gpDisplay,gWindow,"Rotate 2D Color Triangle and 2D Color Square PERSPECTIVE OGL");
...
/**/
	...
	*/
	...
	/*SQUARE*/
	glGenVertexArrays(1, &gVao_square_position);
	glBindVertexArray(gVao_square_position);
...
void UnInitialize()
{
	...
	if (gvao_triangle_color)
	{
		glDeleteVertexArrays(1, &gvao_triangle_color);
		gvao_square_color = 0;
	}

	if (gVao_square_position)
	{
		glDeleteVertexArrays(1, &gVao_square_position);
		gVao_square_position = 0;
	}
	if (gvao_square_color)
	{
		glDeleteVertexArrays(1, &gvao_square_color);
		gvao_square_color = 0;
	}
