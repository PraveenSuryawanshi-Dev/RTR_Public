...
gpDisplay=XOpenDisplay(NULL);
	...
	XStoreName(gpDisplay,gWindow,"Compilation Shader program OpenGL Window");
...
/**/
	...
	const GLchar *vertexshaderprogram=
	"void main(void)"\
	"{"\
	"}";

	//BIND vertexShaderSourcecode CODE TO gVertexShaderObject
	glShaderSource(gVertexShaderObject,1,(const GLchar **)&vertexshaderprogram,NULL);
	...
	const GLchar * fragmentshaderprogram =
	"void main(void)"\
	"{"
	"}";
	
	//Bing fragmentshaderprogram to gFragmentShaderObject
	glShaderSource(gFragmentShaderObject,1,(const GLchar **)&fragmentshaderprogram,NULL);
