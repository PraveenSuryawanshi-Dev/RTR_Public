package com.rtr.Perspective3dRotateColorTriangleAndSquare;
...
{ 
	...
	private int [] vao_pyramid_color = new int[1];
	private float angle_pyramid;
	

	
	private int [] vao_cube_position = new int[1];
	private int [] vao_cube_color = new int[1];
	...
	final float cubeColor[] = new float[]
	{
        ...
        verticesBuffer.put(pyramidColor);
        verticesBuffer.position(0);
	...
	public void draw()
	{
		...
		Matrix.translateM(modelViewMatrix,0, 1.5f, 0.0f, -6.5f);
	...
	public void uninitialize()
	{
        ...
        if(vao_cube_position[0] != 0)
        {
		 ...
		 if(vao_cube_color[0] != 0)
        {
            GLES30.glDeleteVertexArrays(1, vao_cube_color, 0);
            vao_cube_color[0]=0;
        }
		...
		if(vao_pyramid_color[0] != 0)
        {
            GLES30.glDeleteVertexArrays(1, vao_pyramid_color, 0);
            vao_pyramid_color[0]=0;
        }
