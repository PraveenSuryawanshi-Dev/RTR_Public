...
gpDisplay=XOpenDisplay(NULL);
	...
	XStoreName(gpDisplay,gWindow,"Y-Axis rotation pyramid two light one left(RED) and one right(BLUE) using per vertex phong.");
...
void Render()
{
	...
	*/
	...
	//START DRAWING
	glBindBuffer(GL_ELEMENT_ARRAY_BUFFER, gVao_pyramid_position);
