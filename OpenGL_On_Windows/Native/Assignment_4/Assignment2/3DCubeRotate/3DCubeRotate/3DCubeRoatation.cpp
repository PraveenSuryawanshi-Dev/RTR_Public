...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR szCmdLine, int iCmdShow)
{
	...
	TCHAR szAppName[] = TEXT("3D CUBE ROTATION APPLCATION USING OPENGL");
	HDC hdc = NULL;
	HGLRC hglrc = NULL;
...
void Render(HDC hdc)
{
	void DrawMultiColor3DCube();

	glClear(GL_COLOR_BUFFER_BIT | GL_DEPTH_BUFFER_BIT);

	DrawMultiColor3DCube();
...
void DrawMultiColor3DCube()
{
	...
	glRotatef(angleCube, 1.0f, 1.0f, 1.0f); // rotation around Y axis
