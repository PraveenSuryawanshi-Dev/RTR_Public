...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR szCmdLine, int iCmdShow)
{
	...
	TCHAR szAppName[] = TEXT("Simple Texture Loading on Pyramid and Cube OGL");
	HDC hdc = NULL;
	HGLRC hglrc = NULL;
...
void IntializeOpenGL(HWND hwnd, HDC* hdc, HGLRC* hglrc)
{
	...
	*hglrc = wglCreateContext(*hdc);
	...
	LoadGLTexture(&Texture_Kundeli, MAKEINTRESOURCE(IDBITMAP_KUNDELI));
	LoadGLTexture(&Texture_Stone, MAKEINTRESOURCE(IDBITMAP_STONE));
