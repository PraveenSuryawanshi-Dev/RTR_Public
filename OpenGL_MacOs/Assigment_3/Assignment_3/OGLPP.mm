    ...
    window=[[NSWindow alloc] initWithContentRect:win_rect
                                       styleMask:NSWindowStyleMaskTitled | NSWindowStyleMaskClosable | NSWindowStyleMaskMiniaturizable | NSWindowStyleMaskResizable
                                         backing:NSBackingStoreBuffered
                                           defer:NO];
    [window setTitle:@"Tweak Smiley in 2-D Rectangle  in Perspective.(single vao)"];
    [window center];
...
-(void) loadWhiteTexture
{
    ...
    for (i = 0; i < 64; i++)
    {
        for (j = 0; j < 64; j++)
        {
            ...
            white_pixels[i][j][0] = (GLubyte)255;
            white_pixels[i][j][1] = (GLubyte)255;
            white_pixels[i][j][2] = (GLubyte)255;
            white_pixels[i][j][3] = (GLubyte)255;
        }
    }
    ...
    glTexImage2D(GL_TEXTURE_2D, 0/*LOD*/, GL_RGB, 64, 64, 0/*border width*/, GL_BGR, GL_UNSIGNED_BYTE, white_pixels);
