...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR szCmdLine, int iCmdShow)
{
	...
	TCHAR szAppName[] = TEXT("Vertices Colors Normals Textures Array OpenGL");
	HDC hdc = NULL;
	HGLRC hglrc = NULL;
...
void IntializeOpenGL(HWND hwnd, HDC* hdc, HGLRC* hglrc)
{
	...
	*/
	...
	/*color*/
	glGenBuffers(1, &gvao_cube_color);
	glBindBuffer(GL_ARRAY_BUFFER, gvao_cube_color);
	...
	/*textures*/
	glGenBuffers(1, &gVbo_cube_tex_cords);
	glBindBuffer(GL_ARRAY_BUFFER,gVbo_cube_tex_cords);
