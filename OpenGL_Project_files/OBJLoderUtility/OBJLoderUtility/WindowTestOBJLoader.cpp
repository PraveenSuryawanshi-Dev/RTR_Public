...
ModelParser *object_mesh = new ModelParser("C:\\Users\\Praveen Suryawanshi\\Documents\\OBJLoderUtility\\OBJLoderUtility\\pillar.obj");
...
// ModelParser *object_mesh = new ModelParser("C:\\Users\\Praveen Suryawanshi\\Documents\\OBJLoderUtility\\OBJLoderUtility\\IceLandAir.OBJ", false);
...
//ModelParser *object_mesh = new ModelParser("C:\\Users\\Praveen Suryawanshi\\Documents\\OBJLoderUtility\\OBJLoderUtility\\skull.OBJ",false);
...
//ModelParser *object_mesh = new ModelParser("C:\\Users\\Praveen Suryawanshi\\Documents\\OBJLoderUtility\\OBJLoderUtility\\Lamborghini_Aventador.OBJ",false);
...
//ModelParser *object_mesh = new ModelParser("C:\\Users\\Praveen Suryawanshi\\Documents\\OBJLoderUtility\\OBJLoderUtility\\IronMan.OBJ", false);
...
void IntializeOpenGL(HWND hwnd, HDC* hdc, HGLRC* hglrc)
{
	...
	*/
	...
	glBufferData(GL_ARRAY_BUFFER, object_mesh->getSizeOfTexturesCoords(), object_mesh->getTexturesCoords(), GL_STATIC_DRAW);
	glVertexAttribPointer(VDG_ATTRIBUTE_COLOR, object_mesh->getTexCordArrayCount(), GL_FLOAT, GL_FALSE, 0, NULL);
	...
	glBufferData(GL_ARRAY_BUFFER, object_mesh->getSizeOfNormalArray(), object_mesh->getNormalArray(), GL_STATIC_DRAW);
...
void Render(HDC hdc)
{
	...
	*/
	...
	mat4 rotateMatrix = mat4::identity();
	 ...
	 modelMatrix = translate(-290.0f, -20.0f, -350.0f);
	 //modelMatrix = translate(0.0f, 0.0f, -1500.0f);
     //modelMatrix = translate(0.0f, -100.0f, -1000.0f); // for ironman test
