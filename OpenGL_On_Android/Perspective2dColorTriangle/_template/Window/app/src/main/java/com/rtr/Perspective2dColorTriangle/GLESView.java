package com.rtr.Perspective2dColorTriangle;
...
{ 
	...
	private int []vbo_postion = new int[1];
	...
	if(ishadercompilationstatus[0] == GLES30.GL_FALSE)
	{
	 ...
	 //VERTICES COLOR SHADER ATTRIBS VBO , VAO INITIALIZE
	  final float triangleVertices[]= new float[]
		...
		GLES30.glGenBuffers(1,vbo_postion,0);
		GLES30.glBindBuffer(GLES30.GL_ARRAY_BUFFER,vbo_postion[0]);
        ...
        colorsBuffer.put(triangleColor);
	...
	public void uninitialize()
	{
        ...
        if(vbo_postion[0] != 0)
        {
            GLES30.glDeleteBuffers(1, vbo_postion, 0);
            vbo_postion[0]=0;
        }
