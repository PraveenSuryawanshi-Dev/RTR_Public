...
int main(int argc, char** argv)
{
	...
	glutCreateWindow("RECTANGLE FUNCTION WINDOW"); //open the window with "OpenGL First Window : Hello World" in the title bar
...
void display(void)
{
	...
	DrawRectangle(1.0f, 1.0f, 1.0f, 1.0f); //white
